    ...
    return (
        <div className="min-h-screen pt-32 pb-20 px-4 md:px-8">
            <div className="container mx-auto max-w-6xl">
                ...
                {/* Statistics Section */}
                <section className="mb-16">
                    <div className="stats stats-vertical lg:stats-horizontal bg-linear-to-br from-primary/10 to-secondary/10 shadow-xl border border-primary/20 w-full">
                        <div className="stat">
                ...
                <section className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="text-center bg-linear-to-br from-primary/10 to-secondary/10 shadow-xl border border-primary/20  cursor-pointer transition-all hover:-translate-y-2 p-7 rounded-2xl">
